...
def plot_basic(stocks, title='DJI', y_label='Price USD', x_label='Trading Days'):
    """
    Plots basic pyplot
...
def plot_prediction(actual, prediction, title='DJI Trading Vs Prediction', y_label='Price USD', x_label='Trading Days'):
    """
...
def plot_lstm_prediction(actual, prediction, title='DJI Trading vs Prediction', y_label='Price USD', x_label='Trading Days'):
    """
    Plots train, test and prediction
    :param actual: DataFrame containing actual data
    :param prediction: DataFrame containing predicted values
